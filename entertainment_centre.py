...
finding_nemo = media.Movie(
                "Finding Nemo",
                """A clown fish named Marlin who lives in the Great Barrier
                Reef loses his son, Nemo, after he ventures into the open
                sea.""",
...
avengers_age_of_ultron = media.Movie(
                ...
                """When Tony Stark jump-starts a dormant peacekeeping program,
                things go terribly awry, forcing him, Thor (Chris Hemsworth),
                the Incredible Hulk and the rest of the Avengers to
                reassemble.""",
